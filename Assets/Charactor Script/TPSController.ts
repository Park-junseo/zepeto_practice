...
export default class TPSController extends ZepetoScriptBehaviour {
    ...
    public zepetoComp : ZepetoPlayers

    Awake() {
        this.myInputControl = new ZepetoInputControl();

        if(this.zepetoComp != null) 
        {
            this.zepetoComp.cameraData.maxZoomDistance = 0.1;
            this.zepetoComp.cameraData.minZoomDistance = 0.1;
            this.zepetoComp.cameraData.offset = new Vector3(0,0.1,0);
        }
    }
